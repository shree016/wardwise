  ...
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          Welcome to NammaMarg. These terms and conditions outline the rules and
          regulations for the use of NammaMarg&apos;s website and services.
        </p>

        <h2 className="text-xl font-medium mt-8">Acceptance of Terms</h2>

        <p className="mt-8 text-muted-foreground">
          By accessing and using NammaMarg, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          NammaMarg reserves the right to modify these terms at any time. We
        ...
        <p className="mt-8">
          To use NammaMarg, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use NammaMarg for any unlawful or prohibited
        ...
        <p className="mt-8 text-muted-foreground">
          NammaMarg provides a URL shortening service that allows you to create
        ...
        <p className="mt-8 text-muted-foreground">
          NammaMarg offers analytics for your shortened URLs. You agree to use
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          NammaMarg. However, by uploading or creating content, you grant
          NammaMarg a worldwide, non-exclusive, royalty-free license to use,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          NammaMarg does not endorse or assume any liability for user content.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          NammaMarg reserves the right to suspend or terminate your account at
        ...
        <p className="mt-8 text-muted-foreground">
          NammaMarg is provided on an &quot;as is&quot; and &quot;as
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall NammaMarg be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at support@NammaMarg.io.
        </p>

        <p className="mt-8 font-medium">
          By using NammaMarg, you acknowledge that you have read, understood,
